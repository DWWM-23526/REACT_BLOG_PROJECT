...
function ModalContact() {
    ...
    const handleFormSubmit = (event) => {
        ...
        const submitData = async () => {
            try {
                ...
                const alertMessage = (
                    <span>Merci pour votre message {formState.fullname},<br/> 
                    vous recevrez trés prochainement une réponse à l&apos;adresse
                    mail indiquées : {formState.email}</span>
                )
                setAlertProps({type:AlertType.SUCCESS, show: true, children : alertMessage});
                resetForm(true);
    ...
    const getInputClass = (field) => {
        ...
        return formErrors[field] ? "form-control is-invalid" : "form-control is-valid";
    };

    return (<>
        <AlertMessage closeFn={()=>{setAlertProps({show: false})}} {...alertProps} />
